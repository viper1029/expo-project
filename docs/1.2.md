...
- Options (v1.2):
  - **Credits unlock** (recommended durations: 15/30; keep 5 only if iOS implementation proves reliable)
  - **Breathing quest**
...
- Credits unlock (limited): 1 duration option (e.g., 15 min) + fixed pricing
...
- More unlock options:
  - Multiple credit durations & configurable pricing (within safe caps)
